...
#define PC_SERIAL     	  slimSerial1 // PC UI,  PC Command
#define ENCODER_SERIAL    slimSerial2 // PC UI,  PC Command
...
#define USART1_9_BITS_MODE         1                       // 0: 8 bits mode; 1: 9 bits mode
#endif

#if ENABLE_SLIMSERIAL_USART2 == 1
#define USART2_TX_FRAME_MAX_SIZE   4                         //to be 2^n,  Max bytes of Tx frame
#define USART2_RX_FRAME_MAX_SIZE   16                         //to be 2^n,  Max bytes of Rx frame
